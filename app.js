...
interactionStyles.textContent = `
  ...
  .path-card{display:flex;flex-direction:column;min-height:390px}.path-card>small{margin-top:58px}.path-card h2{margin-bottom:14px}.path-card p{margin-bottom:28px}.path-link{bottom:auto;margin-top:auto;position:relative;width:max-content}.path-card-light .path-link{margin-top:auto}@media(max-width:760px){.path-card{min-height:350px}.path-card>small{margin-top:43px}.path-card p{margin-bottom:22px}.path-link{max-width:100%}}
`;
